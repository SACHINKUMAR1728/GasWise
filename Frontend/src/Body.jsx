        ...
        <div className='w-1/2 flex flex-col'>
          <div className="bg-gray-200 text-black px-4 py-2 border-gray-800">
           Try your Smart Contract here: 
            <button className='p-2 rounded-[10px] bg-violet-600 relative left-[470px] px-4 hover:bg-violet-500'>Run</button>
          </div>
          <textarea
...
pragma solidity ^0.8.0...."
  ...
  <div className='text-white bg-gray-800 h-full'>Output div</div>
</div>
